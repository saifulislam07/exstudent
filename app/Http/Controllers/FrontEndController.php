...
class FrontEndController extends Controller
{
    ...
    public function reunion2022()
    {
        $socialMedia = Socialmedia::first();
        $allmember = reunion::get();
        return view('frontend.pages.reunion2022', get_defined_vars());
    }
    ...
    {
        $socialMedia = Socialmedia::first();
        $noticelist = Notice::where('status',1)->orderBy('id', 'desc')->get();
       $lastid = Notice::latest()->orderBy('id', 'desc')->first();
   
        return view('frontend.pages.noticelist', get_defined_vars());
    }
    public function videos()
    {
        $socialMedia = Socialmedia::first();

        return view('frontend.pages.videos', get_defined_vars());
    }
