...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/addnotice', [NoticeController::class, 'create'])->name('addnotice');
    Route::post('/storenotice', [NoticeController::class, 'store'])->name('storenotice');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/reunionregistration', [ReunionController::class, 'index'])->name('reunionregistration');
    Route::get('/addreunionregistration', [ReunionController::class, 'create'])->name('addreunionregistration');
    Route::post('/storereunionregistration', [ReunionController::class, 'store'])->name('storereunionregistration');

    Route::post('/memberdataedit', [ReunionController::class, 'memberdataedit'])->name('memberdataedit');
...
Route::get('/noticelist', [FrontEndController::class, 'noticelist'])->name('noticelist');
...
Route::get('/reunion2022', [FrontEndController::class, 'reunion2022'])->name('reunion2022');
