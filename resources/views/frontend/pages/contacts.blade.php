        ...
        <div class="container inner pt-70">
            <div class="row">
                ...
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <h3 class="section-title text-center alert alert-info text-capitalize " data-aos="flip-left">If you want to
                        donate for poor students,
                        please contact us
                        without any
                        hesitation</h3>
                    ...
                    <div class="row text-center">
                        <div class="col-md-4"> <span class="icon icon-color color-default fs-48 mb-10"><i
                            ...
                            <p>Heshakhal, Nangalkot, Cumilla</p>
                        </div>
                        <!--/column -->
                        <div class="col-md-4"> <span class="icon icon-color color-default fs-48 mb-10"><i
                                    class="si-phone_phone-ringing"></i></span>
                            <p> <a href="tel:{{ $aboutme->contact }}">{{ $aboutme->contact }}</a> <br>
                                <i style="color: green" class="fab fa-viber"></i><a href="https://wa.me/8801916665832">
                                    +8801916665832</a>
                        ...
                        <div class="col-md-4"> <span class="icon icon-color color-default fs-48 mb-10"><i
                            ...
                            <p><a class="nocolor"
                                    href="mailto:{{ $aboutme->email }}">{{ $aboutme->email }}</a><br>
                                <a class="nocolor">info@saifulphoto.com</a>
                            </p>
                        </div>
                        <!--/column -->
                    </div>
