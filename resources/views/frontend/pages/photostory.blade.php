            ...
            <div class="container inner pt-60">
                <div class="row">
                        ...
                        <div class="blog classic-view">
                            <div class="post text-center">
                                <figure class="rounded"><img
                                        src="{{ asset('./storycover/' . $LastStory->storyimage) }}"
                    ...
                    <aside class="col-md-4 sidebar">
                        <div class="sidebox widget">
                            <h3 class="widget-title"><i class="fa fa-list"></i> News list</h3>
                            <ul class="image-list">
                        ...
                        <div class="sidebox widget">
                            <h3 data-aos="fade-up"><i class="fa fa-user"></i> About Us</h3>
                            {{-- <h5 data-aos="fade-down " style="color:rgb(24, 138, 138)">
                                {{ $aboutme->title }}</h5> --}}
                            <figure class="rounded mb-20">
                                <img src="{{ asset('./aboutmes/' . $aboutme->photo) }}" alt="" />
                            </figure>
                            <p>
                        ...
                        <!-- /.widget -->
                        <div class="sidebox widget">
                            <h3 class="widget-title"><i class="fa fa-list-alt"></i> News Categories List</h3>
