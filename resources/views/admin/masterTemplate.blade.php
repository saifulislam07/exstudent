...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('admin_assets/assets/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
    <link rel="stylesheet"
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="/" class="btn btn-info" style="color: white"><i class="fa fa-chevron-circle-left"></i>
                        WEBSITE</a>
                    <a href="" class="btn btn-warning " style="color: white"><i class="fa fa-key"></i> Password</a>
