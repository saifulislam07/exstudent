    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 ">
                    <a href="{{ route('edit-comp') }}" class="btn btn-xs btn-info float-right"><i class="fa fa-edit"></i> EDIT PROFILE</a>
                </div>
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        <hr class="style18">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <tr>
                                            ...
                                            <td colspan="3" style="text-align : center">
                                                ...
                                                <a target="_blank" href="{{ $userDetails->url }}">{{ $userDetails->url }}</a>
                                            </td>
                                        </tr>
