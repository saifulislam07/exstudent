                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-widget widget-user">
                            ...
                            <div class="widget-user-header bg-info">
                                ...
                                <h3 class="widget-user-username">{{ $userDetails->name }} </h3>
                                <h5 class="widget-user-desc">{{ $userDetails->designation }}</h5>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4 border-right">
                                        <div class="description-block">
                                            <span class="description-text" style="text-decoration: underline; font-weight: bold">-: Basic Info :-</span>
                                    ...
                                    <div class="col-sm-4 border-right">
                                        <div class="description-block">
                                            <span class="description-text" style="text-decoration: underline; font-weight: bold">-: Education Info :-</span>
                                    ...
                                    <div class="col-sm-4 ">
                                        <div class="description-block">
                                            <span class="description-text" style="text-decoration: underline; font-weight: bold">-: job Info :-</span>
